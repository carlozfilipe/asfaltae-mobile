...
var PostgresWrapper = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(PostgresWrapper, _super);
...
var AuroraDataApiPostgresDriver = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(AuroraDataApiPostgresDriver, _super);
    // -------------------------------------------------------------------------
    // Constructor
    // -------------------------------------------------------------------------
    ...
    AuroraDataApiPostgresDriver.prototype.loadDependencies = function () {
        var driver = this.options.driver || PlatformTools_1.PlatformTools.load("typeorm-aurora-data-api-driver");
        var pg = driver.pg;
